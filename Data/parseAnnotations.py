...
for i in range(len(inbound_imageID_post_overlap)):
    ...
    output_file = output_folder / ((str(int(inbound_imageID_post_overlap[i])).zfill(8)) + "." + str(multi_image_counter) + ".png")
...
for i in range(len(bg_chip)):
    ...
    output_file = output_folder / (image_string[i] + ".bg." + str(multi_image_counter) + ".png")
